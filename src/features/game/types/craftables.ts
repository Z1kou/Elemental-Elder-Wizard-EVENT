...
export type CraftableName = LimitedItem | Tool | SeedName | Food | Perk;
...
export type Perk = |"Perk1" | "Perk2" | "Perk3";

export const PERKS: Record<Perk, Craftable> = {
  "Perk1": {
    name: "Perk1",
    description: "Increase your pumpkin production +30% for 1 day",
    price: new Decimal(0),
    ingredients: [
      {
        item: "Pumpkin",
    ...
    "Perk2": {
    name: "Perk2",
    description: "Increase your pumpkin production +60% for 1 day",
    price: new Decimal(0),
    ingredients: [
      {
        item: "Pumpkin",
  ...
  "Perk3": {
    name: "Perk3",
    description: "Increase your pumpkin production +75% for 1 day",
    price: new Decimal(0),
    ingredients: [
      {
        item: "Pumpkin",
